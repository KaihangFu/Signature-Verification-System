...
#Load data
train_data = np.loadtxt(open("user10traindataB.csv","rb"),delimiter=",",skiprows=0)
test_data = np.loadtxt(open("user10testdataB.csv","rb"),delimiter=",",skiprows=0)
...
def relu_cross_net(NumUnit,LearnRate,Momentum):
    ...
    print('TestF1 predictions: ', Y_test_pred[0:20])
    print('TestF2 predictions: ', Y_test_pred[20:40])
    print('TestF3 predictions: ', Y_test_pred[40:60])
    print('TestF4 predictions: ', Y_test_pred[60:80])
    print('TestG1 predictions: ', Y_test_pred[80:100])
    print('TestG2 predictions: ', Y_test_pred[100:120])
    print('TestG1 predictions: ', Y_test_pred[120:140])
    print('TestG2 predictions: ', Y_test_pred[140:160])
