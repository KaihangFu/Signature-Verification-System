...
#Load data
train_data = np.loadtxt(open("user4traindataB.csv","rb"),delimiter=",",skiprows=0)
test_data = np.loadtxt(open("user4testdataB.csv","rb"),delimiter=",",skiprows=0)
...
def relu_cross_net(NumUnit,LearnRate,Momentum):
    ...
    print('TestG1 predictions: ', Y_test_pred[88:110])
    print('TestG2 predictions: ', Y_test_pred[110:132])
