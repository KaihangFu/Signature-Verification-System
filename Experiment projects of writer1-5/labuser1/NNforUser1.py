...
#Load data
train_data = np.loadtxt(open("user1traindataB.csv","rb"),delimiter=",",skiprows=0)
test_data = np.loadtxt(open("user1testdataB.csv","rb"),delimiter=",",skiprows=0)
...
def relu_cross_net(NumUnit,LearnRate,Momentum):
    ...
    print('TestG1 predictions: ', Y_test_pred[110:132])
    print('TestG2 predictions: ', Y_test_pred[132:154])
